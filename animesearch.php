...
<head>
    ...
    <link rel="stylesheet" href="css/anime4.css">
            ...
            <div class="col text-center">
                <nav>
                    <div class="nav-bar"><i class='bx bx-menu sidebarOpen'></i><span class="logo navLogo"><img
                                src="css/AniROOM.png" alt="" style="width: 150%;"></span>
                        <div class="menu" style="margin-top:20px;">
                            <div class="logo-toggle"><span class="logo"><img
                src="css/AniROOM.png" alt="" style="width: 200%;margin-left:95px;"></span><i
                        ...
                        <div class="darkLight-searchBox">
                            ...
                            <div class="searchBox">
                                ...
                                <div class="search-field"><input type="text" placeholder="Search..."><i
        ...
        <div class="row divide">
            ...
            echo
                    "<span class='col-4 content'>
                        <h2>
                            <div style='text-align: center;'> <a href='#' class='name-anime'> $nameanime </a>
                            </div>
                        </h2>
                        ...
                        <div class='row'>
                            <div class='col-6'><img class='content-pic' src='css/$imageanime' alt=''></div>
